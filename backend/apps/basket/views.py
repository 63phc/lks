...
from backend.apps.basket.forms import BasketLineForm, BasketVoucherForm, \
    SavedLineForm
from backend.apps.basket.formsets import BasketLineFormSet, SavedLineFormSet
from backend.apps.basket.models import Line, Basket
from backend.core import ajax
from backend.core.utils import safe_referrer, redirect_to_referrer
...
class BasketView(ModelFormSetView):
    ...
    def move_line_to_saved_basket(self, line):
        saved_basket, _ = Basket.saved.get_or_create(
            owner=self.request.user)
